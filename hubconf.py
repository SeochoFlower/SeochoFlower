...
def custom(path='/home/ukiiing00/Yolov5/SeochoFlower/ml/best.pt', autoshape=True, verbose=True, device=None):
...
if __name__ == '__main__':
    ...
    model = custom(path='/home/ukiiing00/Yolov5/SeochoFlower/ml/best.pt')  # custom
